// I, Peter Ragheb, student number 000370848, certify that this material is my
...
namespace Lab1B.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> SeedRoles()
        {
            ...
            {
                Email = "peter@ragheb.com",
                UserName = "peter@ragheb.com",
                FirstName = "Peter",
                LastName = "Ragheb"
            };
            IdentityResult result = await _userManager.CreateAsync(user1, "Password1@");
            if (!result.Succeeded)
                return View("Error", new ErrorViewModel { RequestId = "Failed to add new user1" });
            ...
            result = await _userManager.CreateAsync(user3, "P@ssword1");
            if (!result.Succeeded)
                return View("Error", new ErrorViewModel { RequestId = "Failed to add new user3" });
